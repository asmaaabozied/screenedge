                    ...
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">
                                <span>@lang('site.add')  @lang('site.locations')</span>
                            </h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('dashboard.locations.index') }}"> @lang('site.locations') </a>
                                </li>
                                                ...
                                                <div class="colmd-12">
                                                    ...
                                                    <div class="proSingPage col-lg-12 col-sm-12">
                                                        <div class="col-lg-12 col-sm-12">
                                                            ...
                                                            {{ BsForm::text('address')->label(trans('site.address')) }}
                                                    ...
                                                    <div class="proSingPage col-lg-12 col-sm-12">
                                                        ...
                                                        <div class="col-lg-6 col-sm-12">
                                                            ...
                                                            {{ BsForm::text('phone')->label(trans('site.phone')) }}                                                        </div>
                                                        <div class="col-lg-6 col-sm-12">

                                                            {{ BsForm::text('whatsapp')->label(trans('site.whatsapp')) }}                                                        </div>
                                                    </div>

                                                    <div class="col-lg-12 col-sm-12">

                                                        {{ BsForm::text('email')->label(trans('site.email')) }}                                                        </div>
                                                </div>


                                                    <div class=" proSingPage col-lg-9 col-sm-12">
                                                        <label
                                                            for="projectinput1"> @lang('site.address')  </label>
