                    ...
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0">
                                <span>@lang('site.edit')  @lang('site.companies')</span>
                            </h5>
                        </div>
                                        ...
                                        <div class="card-title">
                                            <div class="row">
                                                ...
                                                <div class="colmd-12">
                                                    ...
                                                    {{ BsForm::resource('companies')->putModel($company, route('dashboard.companies.update', $company)) }}
                                                    <div class="colmd-12">
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            ...
                                                            <div id="app">
                                                                ...
                                                                {{ BsForm::image('avater')->collection('images')->label(trans('site.image'))->files($company->getMediaResource('images'))}}
                                                                {{ BsForm::image('image')->collection('avaters')->label(trans('site.log'))->files($company->getMediaResource('avaters'))}}
